#!/usr/bin/python3
''' From David Love
Python Tkinter by Example - Page 17'''
...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        # Use as main container for its scroll capabilities
        self.tasks_canvas = tk.Canvas(self)

        # Frame child of the tk.Canvas
        self.tasks_frame = tk.Frame(self.tasks_canvas)
        # Frame child of the root
        ...
        # You write the task in here
        self.task_create = tk.Text(self.text_frame, height=3, bg="white",
                                   fg="black")
        ...
        # Create a new window inside canvas. NO NEED TO PACK IT
        # The tasks go here
        self.canvas_frame = self.tasks_canvas.create_window((0, 0), window=
        self.tasks_frame, anchor="n")

        self.task_create.pack(side=tk.BOTTOM, fill=tk.X)
        self.text_frame.pack(side=tk.BOTTOM, fill=tk.X)
        self.task_create.focus_set()

        todo1 = tk.Label(self.tasks_frame, text="--- Add Items Here ---", bg=
        "lightgrey", fg="black", pady=10)
        ...
        self.colour_schemes = [{"bg": "lightgrey", "fg": "black"}, {"bg": "grey",
                                                                    "fg": "white"}]
    ...
    def runQuery(sql, data=None, receive=False):
        '''sql string, data to store, receive return data '''
